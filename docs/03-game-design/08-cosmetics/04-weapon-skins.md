...
Default, gold, carbon fiber, digital camo, and neon glow — applied per weapon class via material/texture swap on the procedural weapon mesh (see 05-rendering/03-procedural-weapons.md). Each weapon has its own independent skin unlock progress.
