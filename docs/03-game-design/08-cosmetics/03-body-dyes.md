...
Olive drab, crimson red, midnight blue, desert tan, and jet black — material color swaps applied to the character's torso/limb geometry via a shared material tint uniform, not separate geometry or textures.
