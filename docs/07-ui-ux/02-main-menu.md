...
Presents: Instant Play (random matchmaking), Server Browser, Private Room creation (generates a
room code), Private Room joining (code entry), Class Selection (stat cards: HP, speed, weapon
loadout, full weapon stats), Settings, and Exit. Instant Play is the most visually prominent action
per 01-overview/03-target-audience.md.
