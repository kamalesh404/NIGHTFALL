...
Defines the Low/Medium/High/Ultra preset matrix (shadow resolution, draw distance, fog mode, material quality). Source of truth for 05-rendering/11-graphics-presets.md.
