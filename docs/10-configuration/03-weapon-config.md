...
Defines, per weapon: damage, fire rate, reload time, magazine capacity, accuracy, range, headshot multiplier, recoil pattern, movement penalty, ADS speed. Source of truth for 03-game-design/02-weapons/.
