...
Feature branches off `main`, named `<area>/<short-description>` (e.g. `combat/recoil-pattern-fix`).
Commits follow conventional-commit-style prefixes (`feat:`, `fix:`, `docs:`, `refactor:`, `test:`)
for a readable history and to support 16-appendix/01-changelog.md generation. PRs require passing
CI (11-testing/07-ci-cd-testing.md) and at least one review before merge to `main`.
