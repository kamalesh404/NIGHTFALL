...
Follow 14-development/03-git-workflow.md for branching/commits/PRs and
14-development/02-coding-standards.md for code style. Be respectful and constructive in reviews;
assume good faith. All contributions must pass CI (11-testing/07-ci-cd-testing.md) before merge.
