...
Once engaged, a bot aims with a configurable accuracy/error cone (see 05-difficulty-levels.md),
fires when the target remains visible, and strafes laterally while shooting to be a less trivial
target. Reload and retreat behavior triggers on low ammo/health thresholds from bot config.
