...
Upstash Redis if/when introduced, used only for session/rate-limit counters and optional
leaderboard read caching (08-backend/07-caching-strategy.md) — not required for Phase 1 launch.
