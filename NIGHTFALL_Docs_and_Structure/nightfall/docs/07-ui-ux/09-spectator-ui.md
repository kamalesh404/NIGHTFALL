...
After death: free camera movement, cycling through alive teammates (previous/next player), an
objective camera (Hardpoint zones or flag carriers), first-person view of the followed player, and
a minimap toggle. Controls are clearly separated from live-gameplay controls (e.g., WASD moves the
free camera, not a player character, while spectating).
