...
A directional red overlay flashes toward the screen edge corresponding to the incoming damage
source's relative direction, fading over a short duration. Multiple simultaneous hits stack their
visual intensity up to a capped maximum rather than layering indefinitely.
