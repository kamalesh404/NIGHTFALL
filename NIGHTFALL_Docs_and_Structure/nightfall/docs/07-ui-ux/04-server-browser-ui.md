...
Columns: server name, player count (current/max), map, mode, ping. Supports filter (map, mode) and
sort (ping, player count) client-side over the listing received from
04-networking/07-server-browser.md; join button disabled once a row reports full.
