...
Tab-toggleable overlay listing all players' kills, deaths, assists, and headshot count, sorted by
kills → assists → lowest deaths (see 03-game-design/06-combat scoring definitions). Medal counts
per player are shown as small icon badges, not a separate tab.
