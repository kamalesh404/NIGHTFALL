...
Defines, per map: spawn points per mode, objective zones (Hardpoint locations, CTF flag bases), collision boundaries, and the baked navigation grid. Source of truth for 03-game-design/03-maps/ and 09-ai-bots/02-navigation-grid.md.
