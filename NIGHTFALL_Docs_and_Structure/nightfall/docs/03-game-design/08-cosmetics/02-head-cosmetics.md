...
Tactical helmet, hood, bandana, beanie, and crown — five procedurally-attached mesh variants swapped onto the character's head socket. Purely cosmetic, no gameplay effect (e.g., no headshot hitbox change).
