...
Project license to be selected by the project owner (e.g., MIT for an open-source release, or
proprietary/all-rights-reserved if kept private). No license is asserted by this document set —
add the actual license text/SPDX identifier here once decided.
