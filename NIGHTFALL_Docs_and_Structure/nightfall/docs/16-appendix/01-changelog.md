...
Document version history. Record entries here when this doc set changes in a way that affects
implementation (a locked decision changes, a new file is added, scope shifts between phases) — not
for every typo fix. Format: `## [date] — <summary>` followed by a short list of changed docs.

## Unreleased
- Initial complete doc set generated from NIGHTFALL_Complete_Project_Plan.md and
  NIGHTFALL_Docs_Directory_Structure.md.
