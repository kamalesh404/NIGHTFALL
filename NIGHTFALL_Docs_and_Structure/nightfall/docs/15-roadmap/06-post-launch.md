...
Content updates (new cosmetics, potential new map/mode) and feature requests are evaluated against
the locked design pillars (01-overview/02-game-design-philosophy.md) before being added to a future
roadmap — nothing here is pre-committed. Maintenance covers dependency updates, security patches,
and monitoring-driven bug fixes as ongoing work beyond Phase 3.
